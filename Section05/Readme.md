...
4.	Realizar el trazado general de las redes a partir de los criterios de localización relacionados en la norma referenciada. Verificando que todos los espacios estén cubiertos porel sistema de rociadores. En la NFPA 13 capítulo <b> "8.8.3 Espaciamiento de los Rociadores ( Rociadores Pulverizadores de Cobertura Extendida, Montantes y Colgantes) " </b> la norma establece en la tabla 8.8.2.1.2 las áreas de protección y espaciamiento máximo de los rociadores con base en el tipo de construcción (con o sin obstrucciones) y en el tipo de riesgo de la edificación. Para la edificación del ejemplo que se considera de riesgo ligero y sin obstrucciones, la norma establece que el espaciamiento entre rociadores es de 20 pies. De acuerdo con esta información, se presenta el plano con la distribución de los rociadores junto con el área de influencia de cada uno para verificar que todos los espacios estén 100% cubiertos. Cabe recordar que normalmente la influencia de los rociadores es 
